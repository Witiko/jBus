...
var tests = {
  ...
  "Integration tests": {
    ...
    "Method JBus.Scope": function(success, failure) {
      ...
      /* We construct a node with a given description and we wait
         until we receive a bonjour message on the broadcast address
      ...
      }), unsubscribe = JBus.services.messages.broadcast.listen(JBus.Scope(), function(msg) {
